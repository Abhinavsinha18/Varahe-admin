...
(function (factory) {
  ...
  var toolbar = renderer.create('<div className="note-toolbar panel-heading"/>');
  ...
  var editable = renderer.create('<div className="note-editable panel-body" contentEditable="true"/>');
  ...
  var ui = {
    ...
    button: function ($node, options) {
      return renderer.create('<button type="button" className="note-btn btn btn-default btn-sm" tabindex="-1">', function ($node, options) {
