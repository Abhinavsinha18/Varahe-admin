...
(function (factory) {
  ...
  var toolbar = renderer.create('<div className="note-toolbar"/>');
  ...
  var editable = renderer.create('<div className="note-editable" contentEditable="true"/>');
  ...
  var button = renderer.create('<button type="button" className="note-btn">', function ($node, options) {
    // set button type
  ...
  var dropdown = renderer.create('<div className="note-dropdown-menu">', function ($node, options) {
    var markup = $.isArray(options.items) ? options.items.map(function (item) {
      var value = (typeof item === 'string') ? item : (item.value || '');
      var content = options.template ? options.template(item) : item;
      var $temp = $('<a className="note-dropdown-item" href="#" data-value="' + value + '"></a>');
  ...
  var dropdownCheck = renderer.create('<div className="note-dropdown-menu note-check">', function ($node, options) {
    var markup = $.isArray(options.items) ? options.items.map(function (item) {
      var value = (typeof item === 'string') ? item : (item.value || '');
      var content = options.template ? options.template(item) : item;
  ...
  var dialog = renderer.create('<div className="note-modal" tabindex="-1"/>', function ($node, options) {
    if (options.fade) {
      $node.addClass('fade');
    }
    $node.html([
      ...
      '      <button type="button" className="close"><i className="note-icon-close"></i></button>' +
  ...
  var popover = renderer.create([
    ...
    '  <div className="note-popover-content note-children-container"/>',
    '</div>'
