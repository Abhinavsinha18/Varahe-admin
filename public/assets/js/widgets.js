$(function(){
  ...
  $('<img className="img-fluid" alt="">').attr('src', map1).appendTo('#map1');
  ...
  $('<img className="img-fluid" alt="">').attr('src', map2).appendTo('#map2');
  ...
  $('<img className="img-fluid" alt="">').attr('src', map3).appendTo('#map3');
